# Generated by Django 4.2.5 on 2024-02-01 11:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('pub', 'Общая группа'), ('pv', 'Приватная бесседа')], default='pub', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rooms', models.ManyToManyField(blank=True, related_name='users', to='messanger_chat.room')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
